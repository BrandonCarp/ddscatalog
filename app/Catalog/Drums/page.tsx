...
"5250-54": { label: "D-5250-54", image: "/images/drums/5250-54.jpg", description: [ "Maximum door height: 8'","Capacity: 265 lbs per drum", `Maximum cable size: 1/8"`, `Cable length: Floor to shaft \n      +63" minus amount of hi-lift`
  ...
  "850-11": { label: "D-850-11", image: "/images/drums/850-11.jpg", description: [ "Maximum door height: 8'","Capacity: 265 lbs per drum", `Maximum cable size: 1/8"`, `Cable length: Floor to shaft +63" minus amount of hi-lift`
   ] },
};

const vertList: { [key: string]: DrumInfo } = {
  "1100-18": { label: "D-1100-18", image: "/images/drums/1100-18.jpg", description: ["Maximum door height: 28'", "Capacity: 800lbs per drum", 'Maximum cable size: 1/4"', 'Cable length: Floor to shaft center +181"'
   ] }
};
      ...
      <CatalogLayout title={"Drums"}>
        <div className="px-5"> {/* Added padding here */}
          ...
          <div className=" border-t  py-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mt-1 items-stretch">
          ...
          {/* Verticle Lift  */}
          <div className="border-t mt- py-5">
  <div className="">
