...
const drumList: { [key: string]: DrumInfo } = {
  ...
  "400-54": { label: "D-400-54", image: "/images/drums/400-54.jpg", description: ["Maximum door height: 32'", "Capacity: 1,100 lbs per drum", 'Maximum cable size: 1/4"', 'Cable length: Floor to \nshaft +14"'] },
};
...
export default function Drums() {
  return (
    <CatalogLayout title={"Drums"} bgcolor={"bg-red-800"} textcolor="text-red-800">
