...
export default function Clo4051() {
  return (
    <>
      <CatalogLayout pagenum="5" title="STOCK RESIDENTIAL">
        {/* Absolute Title */}
        <div className="absolute right-0 mr-20 mt-112 z-10">
          <div className="text-black">
            <h1 className="font-bold inline">Classic Steel Premium /</h1>{" "}
            <span>Model 4053, Classic Long Panel Steel</span>
          </div>
          {/* <div>
        ...
        <div className="relative w-full h-120">
          <Image
            src="/images/StockDoors/4053.jpg"
            alt="Operator Hero"
            fill
            className=""
            priority
        ...
        <div className="relative mt-5">
          ...
          <section className="w-3/5 flex flex-col ml-5">
            <div>
              <h1 className="font-bold text-4xl text-red-900">CLOPAY 4053</h1>
              <p className="font-semibold text-[18px]">
                Upgrade your home’s curb appeal and efficiency with the Clopay
                Classic Steel Premium® 4053. Featuring excellent insulation,
                strength, and quiet performance, it comes in multiple colors and
                window options to fit your style and budget.
              </p>
            </div>
