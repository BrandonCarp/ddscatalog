...
const operatorList: { [key: string]: OperatorInfo } = {
  "87802": { label: "D-87802", image: "/Operators/87802.png", details: "12V DC CHAIN DRIVE OPERATOR (7', 8' & 10') \n WI-FI & BLUETOOTH ENABLED", description: [ "12V DC motor","Security+2.0 myQ with rolling code\n       technology", `893LM remote control`, `882LMW multi-function control panel`, "Soft start/stop for smooth operation", "California complaint model available (81602)"
   ], wifi: "True", myQ: "True", amazonKey: "True"},
    "atswt": { label: "D-atswt", image: "/Operators/atswt.png", details: "DC Battery Backup Chain Drive Wi-Fi", description: [ "12V DC motor","Security+2.0 myQ with rolling code\n       technology", `893LM remote control`, `882LMW multi-function control panel`, "Soft start/stop for smooth operation", "California complaint model available (81602)"
   ], wifi: "True", myQ: "True", amazonKey: "True"},
    "81550": { label: "D-81550", image: "/Operators/81550.png", details: "12V DC CHAIN DRIVE OPERATOR (7', 8' & 10') \n WI-FI & BLUETOOTH ENABLED", description: [ "12V DC motor","Security+2.0 myQ with rolling\n       technology", `893LM remote control`, `882LMW multi-function control panel`, "Soft start/stop for smooth operation", "California complaint model available (81602)"
   ], wifi: "True", myQ: "True", amazonKey: "True"},
    "84505R": { label: "D-84505R", image: "/Operators/84505R.png", details: "12V DC CHAIN DRIVE OPERATOR (7', 8' & 10') \n WI-FI & BLUETOOTH ENABLED", description: [ "12V DC motor","Security+2.0 myQ with rolling\n       technology", `893LM remote control`, `882LMW multi-function control panel`, "Soft start/stop for smooth operation", "California complaint model available (81602)"
   ], wifi: "True", myQ: "True", amazonKey: "True"},
};
