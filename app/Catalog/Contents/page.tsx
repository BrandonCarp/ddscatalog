...
const sections: { [key: string]: number } = {
  ...
  "FASTENERS & ANGLES": 6,
  "LIFT MASTER ACCESSORIES": 8,
  "LIFT MASTER ACCESSORIES ": 9,
  "LIFT MASTER OPERATORS": 10,
  "LIFT MASTER OPERATORS   ": 11,
  "LIFT MASTER OPERATORS ": 12,
  "LIFT MASTER OPERATORS  ": 13,
  "FIXTURES, JAMB BRACKETS & END BEARING PLATES": 14,
  Hinges: 15,
  Inserts: 16,
  Pulleys: 17,
  Rollers: 18,
...
export default function Page() {
  return (
    <CatalogLayout title="TABLE OF CONTENTS" pagenum="1">
      <div className="flex flex-col items-center  min-h-full ">
        ...
        {/* Terms * Conditions */}
        <section className="  grid grid-cols-2 px-10 py-2">
