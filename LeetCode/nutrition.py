...
# that “show nutrition information for the 20 most frequently consumed raw fruits … in the United States. 
# Retail stores are welcome to download the posters, print, display and/or distribute them to consumers in 
...
def main():
    user_fruit = input("Enter a fruit for calories :").lower()
    if user_fruit in fruit_table:
        print(f"{fruit_table[user_fruit]}")
